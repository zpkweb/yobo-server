...
@EntityModel('commodity_options_material')
export class CommodityOptionsMaterialEntity {
  ...
  // // 关联商品选项
  @ManyToMany(type => CommodityMaterialEntity, CommodityMaterialEntity => CommodityMaterialEntity.materials, {
    cascade: true
  })
