...
import { BaseCommodityTechniqueService } from 'src/service/base/commodity/commodity-options/technique';
...
export class CommodityTechniqueService {
  ...
  @Inject()
  baseCommodityTechniqueService: BaseCommodityTechniqueService;
